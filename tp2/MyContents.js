    ...
    */
    ...
    buildSkyBox() {
        ...
        const skyBoxTextures = [
            textureLoader.load('scenes/textures/px.png'),
            textureLoader.load('scenes/textures/nx.png'),
            textureLoader.load('scenes/textures/py.png'),
            textureLoader.load('scenes/textures/ny.png'),
            textureLoader.load('scenes/textures/pz.png'),
