...
class MyApp  {
    ...
    initCameras() {
        ...
        // First-person camera
        const firstPersonCamera = new THREE.PerspectiveCamera(75, aspect, 0.1, 1000);
        this.cameras['FirstPerson'] = firstPersonCamera;

        // Third-person camera
        const thirdPersonCamera = new THREE.PerspectiveCamera(75, aspect, 0.1, 1000);
        this.cameras['ThirdPerson'] = thirdPersonCamera;
